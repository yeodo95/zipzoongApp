...
class BodyWaitingPhoto extends StatefulWidget {
  const BodyWaitingPhoto({Key? key}) : super(key: key);

  @override
  State<BodyWaitingPhoto> createState() => _BodyWaitingPhotoState();
}

class _BodyWaitingPhotoState extends State<BodyWaitingPhoto> {
  @override
